def collection_material(key_materials_dict: dict, junk_materials: dict, material: str, qty: int):
...
while item_obtained == '':
    ...
    for i in range (0, len(current_line), 2):
        ...
        collection_material(key_materials, junk, material_name, material_qty)
